package com.kelompok.pemesanantiket.view.input
...
import com.kelompok.pemesanantiket.viewmodel.InputDataViewModel
...
class DataKapalActivity : AppCompatActivity() {
    ...
    private fun setSpinnerAdapter() {
        ...
        adapterTujuan.setDropDownViewResource(R.layout.simple_spinner_dropdown_item)
        spTujuan.adapter = adapterTujuan

        val adapterKelas =
            ArrayAdapter<CharSequence>(this, R.layout.simple_spinner_item, strKelas)
        adapterKelas.setDropDownViewResource(R.layout.simple_spinner_dropdown_item)
